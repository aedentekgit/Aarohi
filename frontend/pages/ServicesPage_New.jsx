        ...
        <div className="min-h-screen bg-white">
            ...
            <section className="py-24 md:py-32 bg-white">
                <div className="container mx-auto px-6 md:px-12 lg:px-20 max-w-[1440px]">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
                        {services.map((service, index) => (
                            ...
                            >
                                ...
                                {/* Contact Us Link */}
                                <Link to="/contact" className="flex items-center gap-2 text-slate-900 font-semibold text-sm group-hover:text-[#fae606] transition-colors cursor-pointer">
                    ...
                    {/* CTA Section */}
                    <div className="mt-24 bg-slate-50 rounded-3xl p-12 md:p-16 text-center">
                        <h3 className="text-3xl md:text-5xl font-bold text-slate-900 mb-6">
                            Ready to Contact Us?
                        </h3>
                        <p className="text-slate-600 text-lg mb-10 max-w-2xl mx-auto">
                            Get in touch with our team to discuss your requirements and receive a customized solution.
                        </p>
                        <Link to="/contact" className="px-10 py-4 bg-[#fae606] hover:bg-[#e6d500] text-black font-bold rounded-full transition-all duration-300 shadow-lg hover:shadow-xl inline-flex items-center justify-center">
                            Contact Us Today
                        </Link>
                    </div>
                </div>
